...
const shippingController = require('../../controller/device/shipping');
const adaptRequest = require('../../helpers/adaptRequest');
const sendResponse = require('../../helpers/sendResponse');

router.post('/device/api/v1/shipping/create',(req,res,next)=>{
...
router.post('/device/api/v1/shipping/list',(req,res,next)=>{
  req = adaptRequest(req);
...
router.route('/device/api/v1/shipping/count').post((req,res,next)=>{
  req = adaptRequest(req);
...
router.route('/device/api/v1/shipping/aggregate').post((req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/device/api/v1/shipping/softDeleteMany',(req,res,next)=>{
  req = adaptRequest(req);
...
router.post('/device/api/v1/shipping/addBulk',(req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/device/api/v1/shipping/updateBulk',(req,res,next)=>{
  req = adaptRequest(req);
...
router.delete('/device/api/v1/shipping/deleteMany',(req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/device/api/v1/shipping/softDelete/:id',(req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/device/api/v1/shipping/partial-update/:id',(req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/device/api/v1/shipping/update/:id',(req,res,next)=>{
  req = adaptRequest(req);
...
router.get('/device/api/v1/shipping/:id',(req,res,next)=>{
  req = adaptRequest(req);
...
router.post('/device/api/v1/shipping/:id',(req,res,next)=>{
  req = adaptRequest(req);
...
router.delete('/device/api/v1/shipping/delete/:id',(req,res,next)=>{
  req = adaptRequest(req);
