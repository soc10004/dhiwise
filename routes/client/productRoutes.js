...
router.post('/client/api/v1/product/create',(req,res,next)=>{
...
router.post('/client/api/v1/product/list',(req,res,next)=>{
  req = adaptRequest(req);
...
router.route('/client/api/v1/product/count').post((req,res,next)=>{
  req = adaptRequest(req);
...
router.route('/client/api/v1/product/aggregate').post((req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/client/api/v1/product/softDeleteMany',(req,res,next)=>{
  req = adaptRequest(req);
...
router.post('/client/api/v1/product/addBulk',(req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/client/api/v1/product/updateBulk',(req,res,next)=>{
  req = adaptRequest(req);
...
router.delete('/client/api/v1/product/deleteMany',(req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/client/api/v1/product/softDelete/:id',(req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/client/api/v1/product/partial-update/:id',(req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/client/api/v1/product/update/:id',(req,res,next)=>{
  req = adaptRequest(req);
...
router.get('/client/api/v1/product/:id',(req,res,next)=>{
  req = adaptRequest(req);
...
router.post('/client/api/v1/product/:id',(req,res,next)=>{
  req = adaptRequest(req);
...
router.delete('/client/api/v1/product/delete/:id',(req,res,next)=>{
  req = adaptRequest(req);
