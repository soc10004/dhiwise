...
const walletTransactionController = require('../../controller/client/walletTransaction');
const adaptRequest = require('../../helpers/adaptRequest');
const sendResponse = require('../../helpers/sendResponse');

router.post('/client/api/v1/wallettransaction/create',(req,res,next)=>{
...
router.post('/client/api/v1/wallettransaction/list',(req,res,next)=>{
  req = adaptRequest(req);
...
router.route('/client/api/v1/wallettransaction/count').post((req,res,next)=>{
  req = adaptRequest(req);
...
router.route('/client/api/v1/wallettransaction/aggregate').post((req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/client/api/v1/wallettransaction/softDeleteMany',(req,res,next)=>{
  req = adaptRequest(req);
...
router.post('/client/api/v1/wallettransaction/addBulk',(req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/client/api/v1/wallettransaction/updateBulk',(req,res,next)=>{
  req = adaptRequest(req);
...
router.delete('/client/api/v1/wallettransaction/deleteMany',(req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/client/api/v1/wallettransaction/softDelete/:id',(req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/client/api/v1/wallettransaction/partial-update/:id',(req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/client/api/v1/wallettransaction/update/:id',(req,res,next)=>{
  req = adaptRequest(req);
...
router.get('/client/api/v1/wallettransaction/:id',(req,res,next)=>{
  req = adaptRequest(req);
...
router.post('/client/api/v1/wallettransaction/:id',(req,res,next)=>{
  req = adaptRequest(req);
...
router.delete('/client/api/v1/wallettransaction/delete/:id',(req,res,next)=>{
  req = adaptRequest(req);
